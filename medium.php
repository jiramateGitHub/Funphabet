...
imgArray[0].src = 'img/ฉอฉิ่ง.PNG';
ansArray[0] = "ฉ";

imgArray[1] = new Image();
imgArray[1].src = 'img/งองู.PNG';
ansArray[1] = "ง";

imgArray[2] = new Image();
imgArray[2].src = 'img/จอจาน.PNG';
ansArray[2] = "จ";

imgArray[3] = new Image();
imgArray[3].src = 'img/ฆอระฆัง.PNG';
ansArray[3] = "ฆ";

imgArray[4] = new Image();
imgArray[4].src = 'img/ชอช้าง.PNG';
ansArray[4] = "ช";
...
function nextChoice(num,element){
  if(num.value == 2){
    var sound = "งองู";
    document.getElementById('choice[0]').innerHTML = 'ท';
    document.getElementById('choice[1]').innerHTML = 'ร';
    document.getElementById('choice[2]').innerHTML = 'ง';
    document.getElementById('choice[3]').innerHTML = 'ด';
  }else if(num.value == 3){
    var sound = "จอจาน";
    document.getElementById('choice[0]').innerHTML = 'ส';
    document.getElementById('choice[1]').innerHTML = 'ข';
    document.getElementById('choice[2]').innerHTML = 'ต';
    document.getElementById('choice[3]').innerHTML = 'จ';
  }else if(num.value == 4){
    var sound = "ฆอระฆัง";
    document.getElementById('choice[0]').innerHTML = 'ว';
    document.getElementById('choice[1]').innerHTML = 'ฆ';
    document.getElementById('choice[2]').innerHTML = 'ห';
    document.getElementById('choice[3]').innerHTML = 'ฟ';
  }else if(num.value == 5){
    var sound = "ชอช้าง";
    document.getElementById('choice[0]').innerHTML = 'ช';
    document.getElementById('choice[1]').innerHTML = 'ก';
    document.getElementById('choice[2]').innerHTML = 'ม';
...
function loadDoc(element) {
  ...
  xhttp.send("true_stack="+true_stack+"&level=medium");
}

</script>

<?php 
  $check = "medium-".$_COOKIE['name_current'];
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
	...
	<section class="portfolio" id="portfolio" >
		<div class="container portfolio">
			<br>
			<center><img id="myimg" class="img-fluid img-stage my-pulse2" src="img/ฉอฉิ่ง.PNG" alt="https://www.flaticon.com"></center>
			<br>
      <h1 id="num" class="text-center" style="color:#C7F464;">
      ข้อที่ 1 &nbsp
      <img onclick="PlaySound('ฉอฉิ่ง')" style="height:40px;width:40px;" class="img-fluid img-stage my-pulse4" src="img/speaker2.PNG">
      </h1>
			<br>
			<div class="col-lg-12" align="middle">
				<div class="col-sm-6">
					<a onclick="changes(num,0);" class="btn-stage2" >
						<h2 id="choice[0]" style="color:white">ฉ</h2>
					</a>
					<a onclick="changes(num,1);" class="btn-stage2">
						<h2 id="choice[1]" style="color:white">ง</h2>
					</a>
				</div>
				<div class="col-sm-6">
					<a onclick="changes(num,2);" class="btn-stage2">
						<h2 id="choice[2]" style="color:white">ช</h2>
					</a>
					<a onclick="changes(num,3);" class="btn-stage2">
